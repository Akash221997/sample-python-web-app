...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Admin\Documents\Github projects\sample-python-web-app'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Admin\Documents\Github projects\sample-python-web-app\Scripts\deactivate.nu'
